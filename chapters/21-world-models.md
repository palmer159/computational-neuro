...
- **Tolman's rats** — already in the 1940s, rats showed they had cognitive maps and could plan novel routes ([Tolman, 1948](https://psychclassics.yorku.ca/Tolman/Maps/maps.htm)).
...
- Hippocampal preplay and forward sweeps before decision points ([Pfeiffer & Foster, 2013](https://doi.org/10.1038/nature12112)).
...
📄 [Wolpert, Miall & Kawato, 1998 — Internal models in the cerebellum](https://doi.org/10.1016/S1364-6613(98)01221-2).

## Hippocampus as a generative model

📄 [Buckner, 2010 — The role of the hippocampus in prediction and imagination](https://doi.org/10.1146/annurev.psych.60.110707.163508). Patients with hippocampal damage cannot vividly imagine future scenes — episodic memory and episodic future thought are bound together.
...
| | Brain | AI |
|---|---|---|
| **Explicit search** | hippocampal forward replay, deliberate cognition | [MCTS](https://en.wikipedia.org/wiki/Monte_Carlo_tree_search), beam search |
...
- [Pezzulo, Cisek & Friston, 2024 — Generating meaning: active inference and the scope and limits of passive AI](https://doi.org/10.1016/j.tics.2023.10.005).
- [Hamrick, 2019 — Analogues of mental simulation and imagination in deep learning](https://doi.org/10.1016/j.cobeha.2018.12.011).
