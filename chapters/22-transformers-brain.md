...
📄 [Schrimpf et al., 2021](https://www.pnas.org/doi/10.1073/pnas.2105646118) and [Goldstein et al., 2022](https://doi.org/10.1038/s41593-022-00766-3). Transformer LM activations linearly predict cortical language responses, and the better the LM at next-word prediction, the better at brain prediction. Whatever language cortex is doing, it is in the same representational neighborhood as a transformer LM.

### 4. In-context learning ≈ meta-[RL](https://en.wikipedia.org/wiki/Reinforcement_learning)

The mapping in Ch 20: [PFC](https://en.wikipedia.org/wiki/Prefrontal_cortex) + DA implements meta-RL where slow synaptic changes train fast in-activation learners. [LLM](https://en.wikipedia.org/wiki/Large_language_model) in-context learning has the same shape — slow pretraining produces a system that does fast adaptation in activations during inference. If meta-RL is right about PFC, LLMs do something computationally adjacent.
...
- Recurrence improves brain prediction in vision ([Kar et al., 2019](https://doi.org/10.1038/s41593-019-0392-5)) and offers iterative refinement at inference ([RNN-augmented LLMs](https://arxiv.org/abs/2402.11651)).
...
- [Kanwisher, Khosla & Dobs, 2023 — Using artificial neural networks to ask 'why' questions of minds and brains](https://doi.org/10.1016/j.tins.2023.01.007).
