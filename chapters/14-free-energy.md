...
$$F = -\log P(o) + \text{KL}\left[Q(s) \, \| \, P(s|o)\right]$$
...
📄 [Friston, FitzGerald, Rigoli, Schwartenbeck & Pezzulo, 2017 — Active inference: a process theory](https://en.wikipedia.org/wiki/Active_inference). The mechanistic version.
...
- **Reinforcement learning.** Expected free energy decomposes into an exploitation term (KL between predicted and preferred outcomes) and an exploration term (epistemic information gain). RL + curiosity in one principled framework.
...
- **LeCun's H-JEPA / autonomous machine intelligence.** A predictive-coding-meets-energy-based-models proposal that has a great deal of family resemblance to active inference, even though LeCun explicitly distances himself from FEP rhetoric.
...
- See [Colombo & Wright, 2018](https://en.wikipedia.org/wiki/Free_energy_principle#Criticism).
...
- [Parr, Pezzulo & Friston, 2022 — Active Inference (book, MIT Press, free PDF)](https://en.wikipedia.org/wiki/Active_inference) — the canonical textbook.
