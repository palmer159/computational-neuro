...
- [Mountcastle, 1997 — Columnar organization of neocortex](https://doi.org/10.1093/brain/120.4.701) — the canonical-cortex hypothesis.
- [Felleman & Van Essen, 1991 — Hierarchical processing in primate cortex](https://doi.org/10.1093/cercor/1.1.1) — the famous spaghetti diagram.

## Neural coding & representation

- **[Olshausen & Field, 1996 — Sparse coding of natural images](https://www.rctn.org/bruno/papers/sparse-coding.pdf)** — sparse-coding objective recovers [V1](https://en.wikipedia.org/wiki/Visual_cortex) Gabor filters. Now the basis of [LLM](https://en.wikipedia.org/wiki/Large_language_model) [SAE](https://transformer-circuits.pub/2024/scaling-monosemanticity/index.html) interpretability.
- [Pouget, Dayan & Zemel, 2000 — Population codes](https://doi.org/10.1038/35039062) — probability in spike rates.
- [Quian Quiroga & Panzeri, 2009 — Decoding neural populations](https://doi.org/10.1038/nrn2578).
...
- **[Rao & Ballard, 1999 — Predictive coding in V1](https://doi.org/10.1038/4580)** — the most-cited candidate cortical algorithm.
- **[Friston, 2010 — Free-energy principle: a unified brain theory?](https://www.fil.ion.ucl.ac.uk/~karl/The%20free-energy%20principle%20A%20unified%20brain%20theory.pdf)** — the [FEP](https://en.wikipedia.org/wiki/Free_energy_principle) manifesto.
- [Knill & Pouget, 2004 — The Bayesian brain](https://doi.org/10.1016/j.tins.2004.10.007).
- [Whittington & Bogacz, 2017 — Predictive coding ≈ backprop with local rules](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5467749/).

## Memory & hippocampus

- **[McClelland, McNaughton & O'Reilly, 1995 — Complementary learning systems](https://doi.org/10.1037/0033-295X.102.3.419)** — the framework that justified replay buffers.
- **[Hafting et al., 2005 — Grid cells in entorhinal cortex](https://doi.org/10.1038/nature03721)** — Nobel 2014.
- **[Stachenfeld, Botvinick & Gershman, 2017 — Hippocampus as a predictive map](https://doi.org/10.1038/nn.4650)** — successor representations as place + grid cells. Field-defining.
...
- [Whittington et al., 2020 — Tolman-Eichenbaum Machine](https://doi.org/10.1016/j.cell.2020.10.024) — neural model unifying space + relations.
- [Mattar & Daw, 2018 — Prioritized memory access explains replay](https://www.princeton.edu/~ndaw/md18.pdf).

## Reward & [RL](https://en.wikipedia.org/wiki/Reinforcement_learning) in the brain

- **[Schultz, Dayan & Montague, 1997 — Neural substrate of prediction & reward](https://www.gatsby.ucl.ac.uk/~dayan/papers/sdm97.pdf)** — dopamine = [TD](https://en.wikipedia.org/wiki/Temporal_difference_learning) error. Required reading.
...
- [Doya, 2002 — Metalearning and neuromodulation](https://doi.org/10.1016/S0893-6080(02)00044-8) — neuromodulators ↔ RL hyperparameters.
...
- [Goldstein et al., 2022 — Shared computational principles for human + LLM language](https://doi.org/10.1038/s41593-022-00766-3).
- [Beniaguev, Segev & London, 2021 — A single neuron is a deep ANN](https://www.biorxiv.org/content/10.1101/613141v2.full).
- [Kar et al., 2019 — Recurrence helps recognition](https://doi.org/10.1038/s41593-019-0392-5).
...
- [Payeur et al., 2021 — Burstprop / dendritic learning](https://doi.org/10.1038/s41593-021-00857-x).
...
- [Wang et al., 2018 — PFC as meta-RL](https://doi.org/10.1038/s41593-018-0147-8).
- [Banino et al., 2018 — Vector navigation with grid-like RNN units](https://doi.org/10.1038/s41586-018-0102-6) — AI paper that recovered grid cells.
- [LeCun, 2022 — A path towards autonomous machine intelligence](https://openreview.net/pdf?id=BZ5a1r-kVsf) — strongly opinionated [AGI](https://en.wikipedia.org/wiki/Artificial_general_intelligence) architecture proposal.
...
- [Fedorenko, Ivanova & Regev, 2024 — Language network as a natural kind](https://doi.org/10.1038/s41583-024-00802-4) — language is for communication, not thought.
- [Mitchell & Krakauer, 2023 — The debate over understanding in LLMs](https://arxiv.org/abs/2210.13966).

## Consciousness

- [Dehaene & Changeux, 2011 — Global neuronal workspace review](https://doi.org/10.1016/j.neuron.2011.03.018).
- [Tononi et al., 2016 — Integrated information theory](https://www.eecs.qmul.ac.uk/~mpurver/papers/tononi-etal-iit.pdf).
- [Cogitate consortium, 2025 — Adversarial collaboration GWT vs IIT](https://doi.org/10.1038/s41586-025-08888-1).
...
4. **McClelland, McNaughton & O'Reilly, 1995** ([CLS](https://en.wikipedia.org/wiki/Catastrophic_interference) — explains replay buffers and continual learning).
